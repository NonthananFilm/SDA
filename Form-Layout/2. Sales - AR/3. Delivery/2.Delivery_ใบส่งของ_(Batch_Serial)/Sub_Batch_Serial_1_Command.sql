...
[391],	[392],	[393],	[394],	[395],	[396],	[397],	[398],	[399],	[400]
	...
	) As PV ) As rRow ) As Serial ON ODLN.DocEntry = Serial.BaseEntry AND DLN1.LineNum = Serial.BaseLinNum AND DLN1.ItemCode = Serial.ItemCode
-------------------------------------------------------BATCH---------------------------------------------------------------------------------------
LEFT JOIN (SELECT *,
...
[391],	[392],	[393],	[394],	[395],	[396],	[397],	[398],	[399],	[400]
	...
	) As PVB ) As BATCH ) As Batch_N ON ODLN.DocEntry = Batch_N.BaseEntry AND DLN1.LineNum = Batch_N.BaseLinNum AND DLN1.ItemCode = Batch_N.ItemCode

ORDER BY (DLN1.VisOrder+1)
