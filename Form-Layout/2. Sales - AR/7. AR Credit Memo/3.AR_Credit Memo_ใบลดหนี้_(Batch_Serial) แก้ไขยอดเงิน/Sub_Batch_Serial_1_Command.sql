...
WHERE PV.BaseType = 14) As rRow ) As Serial ON ORIN.DocEntry = Serial.BaseEntry AND RIN1.LineNum = Serial.BaseLinNum AND RIN1.ItemCode = Serial.ItemCode
-------------------------------------------------------BATCH---------------------------------------------------------------------------------------
LEFT JOIN (SELECT *,
...
WHERE PVB.BaseType = 14) As BATCH ) As Batch_N ON ORIN.DocEntry = Batch_N.BaseEntry AND RIN1.LineNum = Batch_N.BaseLinNum AND RIN1.ItemCode = Batch_N.ItemCode

ORDER BY (RIN1.VisOrder)+1
