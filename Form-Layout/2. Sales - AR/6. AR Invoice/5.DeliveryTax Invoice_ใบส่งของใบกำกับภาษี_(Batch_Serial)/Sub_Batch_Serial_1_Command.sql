...
WHERE PV.BaseType = 13) As rRow ) As Serial ON OINV.DocEntry = Serial.BaseEntry AND INV1.LineNum = Serial.BaseLinNum AND INV1.ItemCode = Serial.ItemCode
-------------------------------------------------------BATCH---------------------------------------------------------------------------------------
LEFT JOIN (SELECT *,
...
WHERE PVB.BaseType = 13) As BATCH ) As Batch_N ON OINV.DocEntry = Batch_N.BaseEntry AND INV1.LineNum = Batch_N.BaseLinNum AND INV1.ItemCode = Batch_N.ItemCode

ORDER BY (INV1.VisOrder+1)
